...
The manuscript describes SCD, GRD, and EPD as the multi-level knowledge distillation objective. Extra exploratory terms from intermediate development scripts are not part of the default public training objective unless exposed explicitly as optional regularization arguments.
